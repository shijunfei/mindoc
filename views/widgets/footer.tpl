<div class="footer">
    <div class="container">
        <div class="row text-center border-top">
            <span><a href="https://www.mindoc.cn" target="_blank">{{i18n .Lang "common.official_website"}}</a></span>
            <span>&nbsp;·&nbsp;</span>
            ...
            <span>&nbsp;·&nbsp;</span>
            <span><a href="https://demo.mindoc.cn/docs/mindochelp" target="_blank">{{i18n .Lang "common.manual"}}</a></span>
        </div>
        {{if .site_beian}}
